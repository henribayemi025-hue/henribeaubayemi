  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Pour supprimer votre compte : ouvrez « Réglages », puis « Supprimer mon compte » en bas de l’écran. Votre demande est enregistrée et traitée par notre équipe. Vous pouvez aussi nous écrire à ' + CONTACT_EMAIL + '.',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'To delete your account: open “Settings”, then “Delete my account” at the bottom of the screen. Your request is recorded and handled by our team. You may also write to us at ' + CONTACT_EMAIL + '.',
