...
| 24/09 | Beau : « les agents doivent pouvoir, s'ils reçoivent un Excel, travailler, modifier et renvoyer en xlsx » → l'agent rend ses modifications, appliquées sur le vrai fichier, renvoyé en « … (modifié).xlsx » | ✅ code 24/09 soir (essai local : 400 lignes et formules gardées) ; essai réel dans Léo en cours. Reste : la même chose dans la journée de travail (tâches), trier, insérer au milieu |
