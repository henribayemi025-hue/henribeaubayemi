...
| 25/09 | Beau (01 h 15) : dans l'atelier, Ada répond « je ne peux pas te l'afficher, touche Aperçu » → « il doit tout faire lui-même ». Sa capture montrait l'ANCIENNE page (navigateur pas rechargé) ; et il a raison : l'agent doit ouvrir l'aperçu lui-même | en cours : outil « montrer l'aperçu » pour l'agent |
