...
| 25/09 | Beau (~00 h 50) : « tu peux pousser sur finjaro.net… mais les agents n'ont pas encore rendu le travail que tu leur as donné (les 100 points d'Alpha, les autres) » → pointage : 41 tâches données depuis le 23/09, ~20 rendues, 21 en attente parce que personne n'avait relancé le travail depuis 23 h 57 → relancé à 00 h 44 (5 rendus en 2 min). Défaut trouvé CHEZ MOI grâce à Rigo, Semeur et Atelier : un événement de test « PLACEHOLDER » cassait l'outil « fiches » → corrigé (61b116c, déployé 00 h 45). 7 relectures envoyées (Rigo, Semeur, Vigie, Alpha, Écho, Lien, Plume). Mise en ligne finjaro.net : refusée deux fois par le garde-fou des permissions malgré l'accord de Beau → il doit l'autoriser de son côté | en cours · mise en ligne : attend Beau |
