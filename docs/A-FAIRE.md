...
| 25/09 | Beau : « utilise plusieurs outils, même ElevenLabs, pour faire les designs, sinon ce sera trop 2D ; ça doit être RÉEL » | en cours : visuels photoréalistes générés (ElevenLabs et autres) pour la ville, l'immeuble, l'icône |
