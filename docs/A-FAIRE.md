...
| 25/09 | Beau (02 h 50) : réglages GitHub faits (URL de retour, OAuth, secret client). ⚠️ Le secret client est apparu en clair sur sa capture d'écran dans la conversation : à régénérer plus tard par prudence | vérification en cours ; conseil de régénérer donné |
