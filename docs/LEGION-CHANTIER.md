...
| 8 | **Les compétences** prises dans le catalogue (GitHub) et attachées à un agent | Un agent « support client » sait trier des tickets, un agent « dev » sait écrire des tests |
